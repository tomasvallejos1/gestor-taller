...
const PresupuestoForm = () => {
  ...
  // Se llega aca con ?reparacion=<id> desde el boton "Crear presupuesto"
  // de la orden. Solo importa para un presupuesto nuevo: uno existente
  // ya trae su propio reparacion_id.
  const reparacionDesdeUrl = parametros.get('reparacion');
  ...
  const cargar = useCallback(async () => {
    try {
      ...
      if (id) {
        ...
        // ?reparacion=<id> llega desde el boton "Crear presupuesto" de la
        // orden: precarga el vinculo y, de paso, el cliente de esa orden.
        const rep = reparacionDesdeUrl
          ? rs.reparaciones.find((r) => r.id === reparacionDesdeUrl)
          : null;
        setPresupuesto({
